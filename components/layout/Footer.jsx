...
export default function Footer() {
    return (
        <footer className="bg-boda-bg border-t border-boda-green/20 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-1 md:col-span-2">
                        <Link href="/" className="font-script text-4xl text-boda-green-dark mb-4 block">
                            Gestor de Bodas
                        </Link>
                ...
                <div className="border-t border-boda-green/10 pt-8 text-center">
                    <p className="text-boda-text-light text-sm">
                        &copy; {new Date().getFullYear()} Gestor de Bodas. Todos los derechos reservados.
                    </p>
                </div>
            </div>
        </footer>
